...
#compute homogeneous polynomial kernels with degrees 1,2,...,10.
print ('computing Homogeneous Polynomial Kernels...', end='')
from MKLpy.metrics import pairwise
KL = [pairwise.homogeneous_polynomial_kernel(X, degree=d) for d in range(1,11)]
print ('done')
...
clf = EasyMKL(lam=0.1, multiclass_strategy='ova').fit(KL,Y)
